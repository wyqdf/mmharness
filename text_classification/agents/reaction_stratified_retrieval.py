"""Reaction-type stratified retrieval with SMILES-aware matching.

Builds on fewshot_all by adding domain-aware retrieval for chemical reactions.
Groups examples by reaction type and uses character n-grams for SMILES similarity.
Falls back to BM25-style TF-IDF for non-chemical domains.
"""
...
class ReactionStratifiedRetrieval(MemorySystem):
    """Stratified retrieval using reaction types and SMILES n-grams."""
